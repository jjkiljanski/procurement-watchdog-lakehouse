...
Auto-generated from contract_notice_profile.json.
...
class ContractNoticeCoreModel(BaseModel):
    ...
    section_4_1_1: str | None = None
    section_4_1_2: str | None = None
    section_4_1_3: str | None = None
    section_4_1_4: str | None = None
    section_4_1_5: str | None = None
    section_4_1_5_currency: str | None = None
    section_4_1_6: str | None = None
    section_4_1_6_currency: str | None = None
    section_4_1_7: str | None = None
    section_4_1_7_currency: str | None = None
    section_4_1_8: str | None = None
    section_4_1_9: str | None = None
    section_4_1_11: str | None = None
    section_4_1_12: str | None = None
    section_4_1_13: str | None = None
    ...
    section_8_6: str | None = None
    section_8_7: str | None = None
    section_8_9: str | None = None
    section_8_10: str | None = None
    section_8_11: str | None = None
    section_8_18: str | None = None
    section_8_19: str | None = None
    section_8_20: str | None = None
    section_8_21: str | None = None
    section_8_22: str | None = None

class ContractNoticePartModel(BaseModel):
    section_4_2_2: str | None = None
    section_4_2_4: str | None = None
    section_4_2_5: str | None = None
    section_4_2_5_currency: str | None = None
    section_4_2_6: str | None = None
    section_4_2_7: str | None = None
    section_4_2_8: str | None = None
    section_4_2_9: str | None = None
    section_4_2_10_days: str | None = None
    section_4_2_10_end_date: str | None = None
    section_4_2_11: str | None = None
    section_4_2_12: str | None = None
    section_4_2_13: str | None = None
